...
class _ChangeManagementModuleScreenState
    extends State<ChangeManagementModuleScreen>
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text('CR VOLUME — LAST 7 DAYS',
              style: TextStyle(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('7 days ago',
              style: TextStyle(
                  color: _textSecondary.withValues(alpha: 0.7), fontSize: 10)),
  ...
  Widget _contingencyReserveCard() {
    return Container(
      ...
      decoration: const BoxDecoration(
          ...
          border: Border.all(color: _surfaceBorder)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('CONTINGENCY & RESERVE',
            style: TextStyle(
                color: _textSecondary,
                fontSize: 11,
                fontWeight: FontWeight.w700,
        ...
        const SizedBox(height: 16),
        // Contingency
        _reserveBar('Contingency', provider.usedContingency,
            provider.totalContingency, const Color(0xFFD97706)),
        const SizedBox(height: 12),
        // Reserve
          ...
          child:
            ...
            const Text('Total Cost Impact (Approved)',
                style: TextStyle(
                    ...
                    fontSize: 12,
                    fontWeight: FontWeight.w600)),
            Text('\$${provider.totalCostImpact.toStringAsFixed(0)}',
                style: const TextStyle(
          ...
          child:
            ...
            const Text('Total Schedule Impact (Approved)',
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.w600)),
            Text(
                '${provider.totalScheduleImpact > 0 ? "+" : ""}${provider.totalScheduleImpact.round()} days',
                style: TextStyle(
                    color: provider.totalScheduleImpact > 0
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(label,
            style: const TextStyle(
                ...
                fontSize: 12,
                fontWeight: FontWeight.w600)),
        Text('\$${(used / 1000).round()}K / \$${(total / 1000).round()}K',
            style: TextStyle(
  ...
  Widget _impactSummaryCard() {
    return Container(
      ...
      decoration: const BoxDecoration(
          ...
          border: Border.all(color: _surfaceBorder)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('CHANGE IMPACT SUMMARY',
            style: TextStyle(
                color: _textSecondary,
                fontSize: 11,
                fontWeight: FontWeight.w700,
                ...
                Expanded(
                    child: Column(
                      ...
                      Text(cr.title,
                          ...
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis),
                      Text('${cr.crNumber} • ${cr.changeType.label}',
                          style: const TextStyle(
                              color: _textSecondary, fontSize: 10)),
                    ])),
                if (cr.impact.totalCostImpact > 0)
                  Container(
                      ...
                      child: Text(
                          '+\$${(cr.impact.totalCostImpact / 1000).round()}K',
                          style: const TextStyle(
                              color: Color(0xFFEF4444),
                              fontSize: 10,
                              fontWeight: FontWeight.w700))),
                if (cr.impact.totalScheduleImpact != 0)
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(4)),
                      child: Text(
                          '${cr.impact.totalScheduleImpact > 0 ? "+" : ""}${cr.impact.totalScheduleImpact.round()}d',
                          style: TextStyle(
                              color: cr.impact.totalScheduleImpact > 0
                                  ? const Color(0xFFEF4444)
                                  : const Color(0xFF10B981),
  ...
  Widget _recentCRsCard() {
    return Container(
      ...
      decoration: const BoxDecoration(
          ...
          border: Border.all(color: _surfaceBorder)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('RECENT CHANGE REQUESTS',
            style: TextStyle(
                color: _textSecondary,
                fontSize: 11,
                fontWeight: FontWeight.w700,
                ...
                Expanded(
                    child: Column(
                      ...
                      Text(cr.title,
                          ...
                          overflow: TextOverflow.ellipsis),
                      Text(
                          '${cr.crNumber} • ${cr.submittedBy} • ${cr.dateSubmitted.day}/${cr.dateSubmitted.month}/${cr.dateSubmitted.year}',
                          style: const TextStyle(
                              color: _textSecondary, fontSize: 10)),
                    ])),
                Container(
  ...
  Widget _categoryBreakdownCard() {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
          ...
          border: Border.all(color: _surfaceBorder)),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('CHANGES BY CATEGORY',
            style: TextStyle(
                color: _textSecondary,
                fontSize: 11,
                fontWeight: FontWeight.w700,
...
class _ChangeRegisterTabState extends State<_ChangeRegisterTab> {
  ...
  CMStatus? _statusFromString(String s) {
    switch (s) {
      case 'Draft':
        return CMStatus.draft;
      case 'Submitted':
        return CMStatus.submitted;
      case 'Pending Approval':
        return CMStatus.pendingApproval;
      case 'Approved':
        return CMStatus.approved;
      case 'Rejected':
        return CMStatus.rejected;
      case 'Implemented':
        return CMStatus.implemented;
      case 'Closed':
        return CMStatus.closed;
    }
    return null;
  }
  ...
  CMPriority? _priorityFromString(String s) {
    switch (s) {
      case 'Low':
        return CMPriority.low;
      case 'Medium':
        return CMPriority.medium;
      case 'High':
        return CMPriority.high;
      case 'Critical':
        return CMPriority.critical;
      case 'Emergency':
        return CMPriority.emergency;
    }
    return null;
  }
  ...
  List<CMChangeRequest> get _filtered {
    ...
    return widget.provider.changeRequests.where((cr) {
      ...
      if (q.isNotEmpty) {
        final haystack =
            '${cr.crNumber} ${cr.title} ${cr.description} ${cr.submittedBy}'
                .toLowerCase();
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
              '${widget.provider.changeRequests.length} total • ${filtered.length} shown • ${widget.provider.openCRs} open • ${widget.provider.approvedCRs} approved',
            ...
            child:
              ...
              LayoutBuilder(builder: (context, c) {
                ...
                final children = <Widget>[
                  _filterDropdown('Status', _statusFilter, _statusOptions,
                      (v) => setState(() => _statusFilter = v!)),
                  const SizedBox(width: 12),
                  _filterDropdown('Priority', _priorityFilter, _priorityOptions,
          ...
          if (filtered.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  _changeRequestCard(filtered[index], context),
            ),
        ],
      ),
    );
  ...
  Widget _viewToggleBtn(
      IconData icon, bool isActive, VoidCallback onTap, String tooltip) {
    return Tooltip(
      message: tooltip,
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Icon(icon,
              size: 16, color: isActive ? _textPrimary : _textSecondary),
        ),
      ),
    );
  }
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(
              color: _textSecondary.withValues(alpha: 0.5), fontSize: 12),
  ...
  Widget _changeRequestCard(CMChangeRequest cr, BuildContext context) {
    ...
    final compositeColor = composite >= 3.5
        ? const Color(0xFFEF4444)
        : (composite >= 2
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: isSelected
                ...
                : cr.status.color.withValues(alpha: 0.3),
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(children: [
            Container(
                ...
                height: 36,
                decoration: BoxDecoration(
                    color: cr.changeType.color.withValues(alpha: 0.12),
                    borderRadius: BorderRadius.circular(8)),
                child: Icon(cr.changeType.icon,
                    color: cr.changeType.color, size: 18)),
            const SizedBox(width: 12),
            Expanded(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Text(cr.title,
                      style: const TextStyle(
                          ...
                          fontWeight: FontWeight.w700)),
                  Text(
                      '${cr.crNumber} • ${cr.changeType.label} • ${cr.priority.label} Priority',
                      style:
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: compositeColor.withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(6),
                  border:
                      Border.all(color: compositeColor.withValues(alpha: 0.3))),
              child:
                ...
                const Text('COMPOSITE',
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w700,
                        letterSpacing: 0.5)),
                Text(composite.toStringAsFixed(2),
                    style: TextStyle(
              ...
              Container(
                  ...
                  child: const Text('EMERGENCY',
                      style: TextStyle(
                          ...
                          fontSize: 9,
                          fontWeight: FontWeight.w700))),
            if (cr.isAgileRoutineRefinement)
              Container(
                  margin: const EdgeInsets.only(left: 8),
                  padding:
                      const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
        ...
        Padding(
          ...
          child:
            ...
            const SizedBox(height: 8),
            // Justification
            Text('Justification: ${cr.businessJustification}',
                style: const TextStyle(color: _textSecondary, fontSize: 12)),
            ...
            if (cr.approvalSteps.isNotEmpty) ...[
              ...
              const SizedBox(height: 8),
              Row(
                  children: cr.approvalSteps.map((step) {
                ...
                return Expanded(
                  ...
                  if (idx > 0)
                    Container(
                        width: 8,
                        height: 2,
                        color: step.decision == ApprovalDecision.approved
                            ? const Color(0xFF10B981)
                          ...
                          border: Border.all(
                              color: step.decision == ApprovalDecision.approved
                                  ...
                                  : (isCurrent
                                      ...
                                      : const Color(0xFFE4E7EC)),
                              width: 2)),
                      child: step.decision == ApprovalDecision.approved
            ...
            Row(children: [
              OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(
                      color:
                          isSelected ? LightModeColors.accent : _surfaceBorder),
                ),
              ),
              const Spacer(),
            ...
            if (cr.triggersRebaseline) ...[
              ...
              Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: Text(
                            'This change triggers a re-baseline. Affected: ${cr.affectedBaselines.join(", ")}',
                            style: const TextStyle(
...
class _ImpactApprovalSummaryTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final crsWithImpact = provider.changeRequests
        .where((cr) => cr.impact.impactedCount > 0)
        .toList();

    return SingleChildScrollView(
      padding: const EdgeInsets.all(24),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Impact & Approval Summary',
            style: TextStyle(
                color: _textPrimary,
                fontSize: 18,
                fontWeight: FontWeight.w700)),
        const SizedBox(height: 4),
        Text(
            '${crsWithImpact.length} change requests with impact assessments • read-only aggregation',
            style: const TextStyle(color: _textSecondary, fontSize: 13)),
        const SizedBox(height: 20),
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) =>
              _impactApprovalCard(crsWithImpact[index]),
        ),
      ]),
    );
  }
  ...
  Widget _aggregateCard(List<CMChangeRequest> crs) {
    if (crs.isEmpty) {
      return Container(
        ...
        decoration: const BoxDecoration(
            ...
            border: Border.all(color: _surfaceBorder)),
        child: const Center(
            child: Text('No impact assessments recorded yet.',
                style: TextStyle(color: _textSecondary, fontSize: 13))),
      );
    }
    ...
    final avgComposite = crs
            .map((c) => c.impact.compositeImpactScore)
            .fold<double>(0, (s, v) => s + v) /
        crs.length;
    final maxDimIdx = aggregateLevels
        .indexOf(aggregateLevels.reduce((a, b) => a > b ? a : b));
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text('PER-DIMENSION IMPACT (MAX ACROSS ALL CRs)',
              style: TextStyle(
                  color: _textSecondary,
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
          ...
          child:
            ...
            const Text('Highest-impact dimension',
                style: TextStyle(
                    ...
                    fontSize: 11,
                    fontWeight: FontWeight.w600)),
            Text('$maxDimName (L${aggregateLevels[maxDimIdx]})',
                style: const TextStyle(
                    color: Color(0xFFEF4444),
                    fontSize: 12,
                    fontWeight: FontWeight.w800)),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
                color: cr.changeType.color.withValues(alpha: 0.05),
                borderRadius: const BorderRadius.only(
        ...
        Padding(
            ...
            child:
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('IMPACT ASSESSMENT (15 DIMENSIONS)',
                  style: TextStyle(
                      color: _textSecondary,
                      fontSize: 10,
                      fontWeight: FontWeight.w700,
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            if (hasImpact) ...[
                              if (d.scheduleDays != null && d.scheduleDays != 0)
                                Text(
                                    '${d.scheduleDays! > 0 ? "+" : ""}${d.scheduleDays!.round()} days',
                                    style: TextStyle(
                                        color: d.isCritical
                                            ? const Color(0xFFEF4444)
                                            : const Color(0xFF6366F1),
                                        ...
                                        fontWeight: FontWeight.w700)),
                              if (d.costAmount != null && d.costAmount != 0)
                                Text('\$${(d.costAmount! / 1000).round()}K',
                                    style: TextStyle(
                                        color: d.isCritical
                                            ? const Color(0xFFEF4444)
                                            : const Color(0xFF6366F1),
                  ...
                  child: Row(
                      ...
                      children: [
                        _totalChip(
                            'Schedule',
                            '${cr.impact.totalScheduleImpact > 0 ? "+" : ""}${cr.impact.totalScheduleImpact.round()}d',
                            cr.impact.totalScheduleImpact > 0
                                ? const Color(0xFFEF4444)
                                : const Color(0xFF10B981)),
                        _totalChip(
                            'Cost',
                            '\$${(cr.impact.totalCostImpact / 1000).round()}K',
                            cr.impact.totalCostImpact > 0
                                ? const Color(0xFFEF4444)
                                : const Color(0xFF10B981)),
                        _totalChip(
                            'Dimensions',
  ...
  Widget _totalChip(String label, String value, Color color) {
    return Column(children: [
      Text(label,
          style: const TextStyle(
              color: _textSecondary, fontSize: 9, fontWeight: FontWeight.w600)),
      Text(value,
          style: TextStyle(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
              child: Column(
                ...
                const SizedBox(height: 4),
                Text(
                    '${widget.provider.auditTrail.length} total • ${filtered.length} shown • Immutable record',
                    style:
        ...
        Container(
          ...
          child:
            ...
            LayoutBuilder(builder: (context, c) {
              final wide = c.maxWidth > 720;
              final actorDropdown = _filterDropdown('Actor', _actorFilter,
                  _actorOptions, (v) => setState(() => _actorFilter = v!));
              final actionDropdown = _filterDropdown(
                  'Action Type',
                  _actionFilter,
                  _actionOptions,
                  (v) => setState(() => _actionFilter = v!));
              final fromBtn = _dateButton(
                  'From', _fromDate, () => _pickDate(context, true));
              final toBtn =
                  _dateButton('To', _toDate, () => _pickDate(context, false));
              if (wide) {
                return Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
        ...
        if (widget.provider.baselineHistory.isNotEmpty) ...[
          const Text('BASELINE REVISION HISTORY',
              style: TextStyle(
                  color: _textSecondary,
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                        Text('Baseline v${rev.version} - ${rev.reason}',
                            style: const TextStyle(
                                color: _textPrimary,
                                fontSize: 12,
                                fontWeight: FontWeight.w600)),
                        Text(
                            'By ${rev.revisedBy} • ${rev.revisionDate.day}/${rev.revisionDate.month}/${rev.revisionDate.year}${rev.approver != null ? " • Approver: ${rev.approver}" : ""}',
                            style: const TextStyle(
                                color: _textSecondary, fontSize: 10)),
                        if (rev.previousBudget != null &&
                            rev.revisedBudget != null)
                          Text(
                              'BAC \$${rev.previousBudget!.toStringAsFixed(0)} → \$${rev.revisedBudget!.toStringAsFixed(0)}',
                              style: const TextStyle(
                                  color: Color(0xFFEF4444),
                                  fontSize: 10,
                                  fontWeight: FontWeight.w700)),
                        if (rev.previousScopeHash != null &&
                            rev.revisedScopeHash != null)
                          Text(
                              'Scope ${_shortHash(rev.previousScopeHash)} → ${_shortHash(rev.revisedScopeHash)}',
                              style: const TextStyle(
                                  color: _textSecondary, fontSize: 9)),
                      ])),
                ]),
      ...
      Container(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            isExpanded: true,
            icon:
                const Icon(Icons.expand_more, size: 16, color: _textSecondary),
            style: const TextStyle(
...
class _CreateCRTabState extends State<_CreateCRTab> {
  ...
  void _submit() {
    ...
    final crId = widget.provider.createChangeRequest(
      ...
      alternativesConsidered:
          _altCtrl.text.trim().isEmpty ? null : _altCtrl.text.trim(),
      submittedBy: _originatorCtrl.text.trim().isEmpty
          ? null
          : _originatorCtrl.text.trim(),
  ...
  Widget build(BuildContext context) {
    ...
    final previewCrNumber =
        'CR-$year-${(widget.provider.changeRequests.length + 1).toString().padLeft(3, '0')}';
    return SingleChildScrollView(
      padding: const EdgeInsets.all(24),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Create Change Request',
            style: TextStyle(
                color: _textPrimary,
                fontSize: 18,
                fontWeight: FontWeight.w700)),
        const SizedBox(height: 4),
        const Text(
            'Submit a new CR with identification, scope, cost & schedule impact, and supporting documents.',
            style: TextStyle(color: _textSecondary, fontSize: 13)),
        const SizedBox(height: 20),
        // SECTION A — IDENTIFICATION
        _sectionCard(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Expanded(
                  child: _readOnlyField('CR Number (auto)', previewCrNumber)),
              const SizedBox(width: 12),
              Expanded(
                  child: _readOnlyField('Status (auto)',
                      _isEmergency ? 'Emergency' : 'Submitted')),
            ]),
            const SizedBox(height: 12),
            _textField(
                'Title *', _titleCtrl, 'e.g. Add Fire Suppression System'),
            const SizedBox(height: 12),
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(
                  child:
                      _textField('Originator', _originatorCtrl, 'Name & role')),
              const SizedBox(width: 12),
              Expanded(
                  child:
                      _dateField('Date Raised', _dateRaised, _pickDateRaised)),
            ]),
            const SizedBox(height: 12),
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(
                  child: _dropdownField<CMChangeType>(
                      'Change Type',
                      _type,
                      CMChangeType.values,
                      (t) => t.label,
              ...
              const SizedBox(width: 12),
              Expanded(
                  child: _dropdownField<CMPriority>(
                      'Priority',
                      _priority,
                      CMPriority.values,
                      (p) => p.label,
            ...
            CheckboxListTile(
              ...
              title: const Text('Emergency Change',
                  style: TextStyle(fontSize: 13)),
              subtitle: const Text(
                  'Emergency changes bypass standard workflow and require sponsor sign-off within 24h.',
        ...
        _sectionCard(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            _textField('Rich Description *', _descCtrl,
                'Detailed description of the requested change',
                maxLines: 4),
            const SizedBox(height: 12),
            _textField('Business Justification *', _justCtrl,
                'Why this change is needed and the cost of inaction',
                maxLines: 3),
            const SizedBox(height: 12),
            _textField('Alternatives Considered', _altCtrl,
        ...
        _sectionCard(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('AFFECTED WORK PACKAGES (multi-select)',
                style: TextStyle(
                    color: _textSecondary,
                    fontSize: 10,
                    fontWeight: FontWeight.w700,
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(
                  child: _currencyField(
                      'Contingency Drawdown (\$)', _contingencyCtrl)),
              const SizedBox(width: 12),
              Expanded(
                  child: _currencyField('Reserve Drawdown (\$)', _reserveCtrl)),
            ]),
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.all(12),
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Text(
                        'Contingency: \$${widget.provider.remainingContingency.toStringAsFixed(0)} available • Reserve: \$${widget.provider.remainingReserve.toStringAsFixed(0)} available',
                        style: const TextStyle(
                            color: _textSecondary, fontSize: 11))),
              ]),
            ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                      'Drawings, cost estimates, vendor quotes, RFIs — PDF, DOCX, XLSX up to 25 MB',
                      style: TextStyle(
  ...
  Widget _dropdownField<T>(String label, T value, List<T> options,
  ...
  Widget _numberField(String label, TextEditingController ctrl, Color color,
...
class _ImpactDetailTabState extends State<_ImpactDetailTab> {
  ...
  Future<void> _pickDueDate(int index) async {
    final picked = await showDatePicker(
      context: context,
      initialDate:
          _dueDates[index] ?? DateTime.now().add(const Duration(days: 30)),
  ...
  void _save() {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'Impact assessment saved for ${cr.crNumber} • composite ${updated.compositeImpactScore.toStringAsFixed(2)}'),
          behavior: SnackBarBehavior.floating,
          backgroundColor: const Color(0xFF10B981),
        ),
      );
  ...
  Widget build(BuildContext context) {
    final cr = widget.selectedCR;
    if (cr == null) {
      return _emptyState('No change requests available',
          'Create a CR first to perform an impact assessment.');
    }
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                const Text('Impact Assessment Detail',
                    style: TextStyle(
                        color: _textPrimary,
                        fontSize: 18,
                        fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text('Editing ${cr.crNumber} • ${cr.title}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 13)),
              ])),
          Container(
              ...
              child:
                ...
                const Text('COMPOSITE SCORE',
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w700,
                        letterSpacing: 0.5)),
                Text(_showComposite ? composite.toStringAsFixed(2) : '—',
                    style: TextStyle(
                        color: compositeColor,
                        fontSize: 18,
                        fontWeight: FontWeight.w900)),
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              style: const TextStyle(
                  ...
                  fontSize: 12,
                  fontWeight: FontWeight.w600),
              items: widget.provider.changeRequests
                  .map((c) => DropdownMenuItem(
                      value: c.id,
                      child: Text('${c.crNumber} • ${c.title}',
                          overflow: TextOverflow.ellipsis)))
                  .toList(),
              onChanged: (v) {
                if (v != null) widget.onSelectCR(v);
              },
            ),
          ),
        ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Row(children: [
            ...
            if (_showComposite) ...[
              const SizedBox(width: 12),
              Text('Composite = ${composite.toStringAsFixed(2)} / 5.00',
                  style: TextStyle(
                      color: compositeColor,
                      fontSize: 13,
                      fontWeight: FontWeight.w700)),
  ...
  Widget _dimensionCard(int index, ImpactDimension d) {
    ...
    final levelColor = level >= 4
        ...
        : (level >= 3
            ? const Color(0xFFF59E0B)
            : (level >= 1 ? const Color(0xFF10B981) : const Color(0xFF9CA3AF)));
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 6),
              Text(
                  _dueDates[index] == null
                      ? 'Due date'
                      : 'Due ${_dueDates[index]!.day}/${_dueDates[index]!.month}/${_dueDates[index]!.year}',
                  style: TextStyle(
                      color: _dueDates[index] == null
                          ? _textSecondary.withValues(alpha: 0.5)
                          : _textPrimary,
                      fontSize: 11,
                      fontWeight: FontWeight.w600)),
              const Spacer(),
              if (_dueDates[index] != null)
                GestureDetector(
                  onTap: () => setState(() => _dueDates[index] = null),
                  child:
                      const Icon(Icons.clear, size: 12, color: _textSecondary),
                ),
            ]),
          ),
        ),
...
class _WorkflowTabState extends State<_WorkflowTab> {
          ...
          content: SizedBox(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              TextField(
                  controller: nameCtrl,
                  decoration:
                      const InputDecoration(labelText: 'Decision-maker name'),
                  style: const TextStyle(color: Color(0xFF1A1D1F))),
              const SizedBox(height: 12),
              Row(children: [
                Expanded(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Recording decision on ${cr.crNumber} step "$roleLabel".',
                    style:
                ...
                if (decision == ApprovalDecision.escalated) ...[
                  const SizedBox(height: 12),
                  TextField(
                      controller: escalationTargetCtrl,
                      decoration: const InputDecoration(
                          labelText: 'Escalation target (role/name)'),
                      style: const TextStyle(color: Color(0xFF1A1D1F))),
                  const SizedBox(height: 8),
                  TextField(
                      controller: escalationReasonCtrl,
                      maxLines: 2,
                      decoration: const InputDecoration(
                ...
                if (decision == ApprovalDecision.delegated) ...[
                  const SizedBox(height: 12),
                  TextField(
                      controller: delegatedFromCtrl,
                      decoration: const InputDecoration(
                          labelText:
                              'Delegated from (original decision-maker)'),
                      style: const TextStyle(color: Color(0xFF1A1D1F))),
                ],
              ]),
        ),
          ...
          ElevatedButton(
            onPressed: () {
              widget.provider.recordApprovalDecision(
                ...
                escalationTarget: decision == ApprovalDecision.escalated
                    ? (escalationTargetCtrl.text.trim().isEmpty
                        ? null
                        : escalationTargetCtrl.text.trim())
                    : null,
                escalationReason: decision == ApprovalDecision.escalated
                    ? (escalationReasonCtrl.text.trim().isEmpty
                        ? null
                        : escalationReasonCtrl.text.trim())
                    : null,
                delegatedFrom: decision == ApprovalDecision.delegated
                    ? (delegatedFromCtrl.text.trim().isEmpty
                        ? null
                        : delegatedFromCtrl.text.trim())
                    : null,
              );
              Navigator.pop(ctx);
            },
            style: ElevatedButton.styleFrom(
                backgroundColor: decision.color, foregroundColor: Colors.white),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                const Text('Approval Workflow Builder',
                    style: TextStyle(
                        color: _textPrimary,
                        fontSize: 18,
                        fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text('${cr.crNumber} • ${cr.title} • ${steps.length} step(s)',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 13)),
              ])),
          Row(children: [
              ...
              onPressed: canFinalize
                  ? () {
                      ...
                      if (mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(cr.approvalSteps.every((s) =>
                                    s.decision == ApprovalDecision.approved)
                                ? '${cr.crNumber} finalized → APPROVED'
                                : '${cr.crNumber} finalized → REJECTED'),
                            behavior: SnackBarBehavior.floating,
                            backgroundColor: cr.approvalSteps.every((s) =>
                                    s.decision == ApprovalDecision.approved)
                                ? const Color(0xFF10B981)
                                : const Color(0xFFEF4444),
                          ),
        ...
        Container(
          ...
          child:
            ...
            _statChip(
                'Pending',
                '${steps.where((s) => s.decision == ApprovalDecision.pending).length}',
                const Color(0xFFF59E0B)),
            _statChip(
                'Escalated',
                '${steps.where((s) => s.decision == ApprovalDecision.escalated).length}',
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                  child: Text(
                      allTerminal
                          ? 'All steps have terminal decisions — but the CR status is ${cr.status.label}. Finalize is available for in-flight CRs only.'
                          : 'Finalize is enabled once every step has a terminal decision (approved / rejected / delegated / escalated / returned).',
                      style: const TextStyle(
        ...
        ...steps.asMap().entries.map((entry) {
          ...
          return _stepTimelineCard(
              i + 1, step, cr.currentStepIndex == i, isLast);
        }),
        const SizedBox(height: 24),
      ]),
    );
  ...
  Widget _stepTimelineCard(
      int stepNum, CMApprovalStep step, bool isCurrent, bool isLast) {
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        SizedBox(
          ...
          child: Column(children: [
            Container(
              ...
              height: 32,
              decoration: BoxDecoration(
                color: decision == ApprovalDecision.pending
                    ? const Color(0xFFF9FAFB)
            ...
            if (!isLast)
              Expanded(
                  child: Container(
                      width: 2,
                      color: decision == ApprovalDecision.approved
                          ? const Color(0xFF10B981)
                          : _surfaceBorder)),
          ]),
        ),
        ...
        Expanded(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
                color: isCurrent ? LightModeColors.accent : _surfaceBorder,
                width: isCurrent ? 2 : 1),
          ),
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              if (step.dueDate != null) ...[
                ...
                const SizedBox(width: 4),
                Text(
                    'Due ${step.dueDate!.day}/${step.dueDate!.month}/${step.dueDate!.year}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 11)),
              ],
              const Spacer(),
              if (step.decidedAt != null) ...[
                ...
                const SizedBox(width: 4),
                Text(
                    'Decided ${step.decidedAt!.day}/${step.decidedAt!.month}/${step.decidedAt!.year}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 11)),
              ],
            ]),
                  ...
                  child: Column(
                      ...
                      children: [
                        Row(children: [
                          ...
                          Expanded(
                              child: Text(
                                  'Escalated to: ${step.escalationTarget}',
                                  style: const TextStyle(
                                      color: Color(0xFFDC2626),
                                      fontSize: 11,
                                      fontWeight: FontWeight.w600))),
                        ...
                        if (step.escalationReason != null) ...[
                          const SizedBox(height: 4),
                          Text('Reason: ${step.escalationReason}',
                              style: const TextStyle(
                                  color: Color(0xFFDC2626), fontSize: 10)),
                        ],
                      ])),
            ],
            ...
            if (decision == ApprovalDecision.pending) ...[
              ...
              Wrap(spacing: 8, runSpacing: 8, children: [
                _decisionButton('Approve', ApprovalDecision.approved, step.id,
                    step.roleLabel),
                _decisionButton('Reject', ApprovalDecision.rejected, step.id,
                    step.roleLabel),
                _decisionButton('Defer', ApprovalDecision.returnRevision,
                    step.id, step.roleLabel),
                _decisionButton('Delegate', ApprovalDecision.delegated, step.id,
                    step.roleLabel),
                _decisionButton('Escalate', ApprovalDecision.escalated, step.id,
                    step.roleLabel),
              ]),
            ],
          ]),
  ...
  Widget _decisionButton(String label, ApprovalDecision decision, String stepId,
      String roleLabel) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(6),
            side: BorderSide(color: decision.color.withValues(alpha: 0.3))),
      ),
      child: Text(label,
...
class _ImplementationTabState extends State<_ImplementationTab> {
            ...
            onPressed: () {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                        'Baseline v$v applied — BAC now \$${widget.provider.currentBAC.toStringAsFixed(0)}'),
                    behavior: SnackBarBehavior.floating,
                    backgroundColor: const Color(0xFF10B981),
                  ),
                );
            ...
            onPressed: () {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(ok
                        ? 'Baseline rolled back — BAC restored to \$${widget.provider.currentBAC.toStringAsFixed(0)}'
                        : 'No baseline revisions to roll back.'),
                    behavior: SnackBarBehavior.floating,
                    backgroundColor:
                        ok ? const Color(0xFFEF4444) : const Color(0xFF6B7280),
                  ),
                );
              }
            },
  ...
  Widget build(BuildContext context) {
    ...
    if (cr == null) {
      return _emptyState('No change requests available',
          'Select an approved CR to track its implementation.');
    }
    ...
    final doneCount =
        tasks.where((t) => t.status == ImplementationStatus.done).length;
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                const Text('Implementation & Baseline',
                    style: TextStyle(
                        color: _textPrimary,
                        fontSize: 18,
                        fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text('${cr.crNumber} • ${cr.title} • ${cr.status.label}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 13)),
              ])),
          Row(children: [
            ElevatedButton.icon(
              onPressed: isApproved && cr.impact.requiresRebaseline
                  ? _confirmApplyToBaseline
                  : null,
            ...
            child: DropdownButton<String>(
              ...
              items: widget.provider.changeRequests
                  .map((c) => DropdownMenuItem(
                      value: c.id,
                      child: Text(
                          '${c.crNumber} • ${c.title} [${c.status.label}]',
                          overflow: TextOverflow.ellipsis)))
                  .toList(),
              onChanged: (v) {
                if (v != null) widget.onSelectCR(v);
        ...
        if (!isApproved) ...[
          ...
          Container(
            ...
            child:
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                _progressChip(
                    'To-Do',
                    '${tasks.where((t) => t.status == ImplementationStatus.todo).length}',
                    const Color(0xFF6B7280)),
                _progressChip(
                    'In Progress',
                    '${tasks.where((t) => t.status == ImplementationStatus.inProgress).length}',
                    const Color(0xFFF59E0B)),
          ...
          const Text('IMPLEMENTATION TASKS',
              style: TextStyle(
                  color: _textSecondary,
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
          ...
          if (tasks.isEmpty)
            Container(
              ...
              child: const Center(
                  child: Text(
                      'No implementation tasks. Add some via the provider.addImplementationTask method.',
                      style: TextStyle(color: _textSecondary, fontSize: 12))),
            )
          else
            ListView.builder(
        ...
        if (baselineHistory.isEmpty)
          Container(
            ...
            decoration: const BoxDecoration(
                ...
                border: Border.all(color: _surfaceBorder)),
            child: const Center(
                child: Text('No baseline revisions recorded yet.',
                    style: TextStyle(color: _textSecondary, fontSize: 12))),
          )
        else
          Builder(builder: (context) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  _baselineRevisionCard(reversed[index]),
            );
          }),
        const SizedBox(height: 24),
      ]),
        ...
        Row(children: [
          ...
          Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                Text(task.workPackageName,
                    style: const TextStyle(
                        color: _textPrimary,
                        fontSize: 13,
                        fontWeight: FontWeight.w700)),
                Text(
                    '${task.workPackageId}${task.assignee != null ? " • ${task.assignee}" : ""}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 10)),
              ])),
          if (task.completedAt != null)
            Text(
                'Done ${task.completedAt!.day}/${task.completedAt!.month}/${task.completedAt!.year}',
                style: const TextStyle(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<ImplementationStatus>(
                      ...
                      style: TextStyle(
                          ...
                          fontSize: 11,
                          fontWeight: FontWeight.w700),
                      items: ImplementationStatus.values
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      value: task.assignee != null &&
                              _assigneeOptions.contains(task.assignee)
                          ? task.assignee
                          : null,
                      hint: Text(task.assignee ?? 'Assign…',
                          style: const TextStyle(
                              color: _textPrimary,
                              fontSize: 11,
                              fontWeight: FontWeight.w600),
          ...
          child: Column(children: [
            ...
            Row(children: [
              ...
              if (rev.previousBudget != null && rev.revisedBudget != null) ...[
                Text('\$${rev.previousBudget!.toStringAsFixed(0)}',
                    style: const TextStyle(
                        color: _textSecondary,
                        fontSize: 11,
                ...
                const Icon(Icons.arrow_forward,
                    size: 12, color: _textSecondary),
                Text('\$${rev.revisedBudget!.toStringAsFixed(0)}',
                    style: const TextStyle(
                        color: Color(0xFFEF4444),
                        fontSize: 12,
                        fontWeight: FontWeight.w800)),
            ...
            Row(children: [
              ...
              if (rev.previousScopeHash != null &&
                  rev.revisedScopeHash != null) ...[
                Text(_shortHash(rev.previousScopeHash),
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 10)),
                const Icon(Icons.arrow_forward,
                    size: 12, color: _textSecondary),
            ...
            Row(children: [
              ...
              if (rev.previousFinish != null && rev.revisedFinish != null) ...[
                Text(
                    '${rev.previousFinish!.day}/${rev.previousFinish!.month}/${rev.previousFinish!.year}',
                    style:
                        const TextStyle(color: _textSecondary, fontSize: 11)),
                const Icon(Icons.arrow_forward,
                    size: 12, color: _textSecondary),
                Text(
                    '${rev.revisedFinish!.day}/${rev.revisedFinish!.month}/${rev.revisedFinish!.year}',
                    style: const TextStyle(
                        color: Color(0xFF10B981),
                        fontSize: 11,
                        fontWeight: FontWeight.w700)),
...
class _SparklinePainter extends CustomPainter {
  ...
  final double max;
  _SparklinePainter(
      {required this.values, required this.color, required this.max});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var g = 1; g <= 3; g++) {
      ...
      canvas.drawLine(
          ...
          Offset(w, y),
          Paint()
            ..color = const Color(0xFFE4E7EC).withValues(alpha: 0.4)
            ..strokeWidth = 0.5);
    }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var lvl = 0; lvl <= 5; lvl++) {
      ...
      canvas.drawLine(
          ...
          Paint()
            ..color =
                const Color(0xFFE4E7EC).withValues(alpha: lvl == 0 ? 0.7 : 0.3)
            ..strokeWidth = 0.5);
    }
    ...
    for (var i = 0; i < n; i++) {
      ...
      final trackR = RRect.fromRectAndRadius(
          Rect.fromLTWH(barX, barTop, barMaxW, barH), const Radius.circular(3));
      ...
      if (lvl > 0) {
        final barR = RRect.fromRectAndRadius(
            Rect.fromLTWH(barX, barTop, barLen, barH),
      ...
      lvlTp.paint(
          canvas, Offset(barX + barMaxW + 4, rowCenter - lvlTp.height / 2));
    }
  }
