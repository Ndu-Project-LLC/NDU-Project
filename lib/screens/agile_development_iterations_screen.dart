...
class AgileDevelopmentIterationsScreen extends StatefulWidget {
  ...
  static void open(BuildContext context) {
    context.push('/agile-development-iterations');
  }
...
class _AgileDevelopmentIterationsScreenState
  ...
  Future<void> _showAddTaskDialog(BuildContext context) async {
    ...
    try {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items:
                          const ['Critical', 'High', 'Medium', 'Low'].map((p) {
                        return DropdownMenuItem<String>(
                      ...
                      Padding(
                        ...
                        child: DropdownButtonFormField<String>(
                          value: selectedFeatureId.isNotEmpty
                              ...
                              : null,
                          decoration:
                              const InputDecoration(labelText: 'Feature'),
      ...
      iterationNotesController.dispose();
    }
  }
  ...
  Future<List<Milestone>?> _loadMilestonesForPicker() async {
    ...
    final milestones =
        data.keyMilestones.where((m) => m.name.trim().isNotEmpty).toList();
