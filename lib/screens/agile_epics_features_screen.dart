...
class _AgileEpicsFeaturesScreenState extends State<AgileEpicsFeaturesScreen> {
                          ...
                          if (_selectedEpicId != null) ...[
                            ...
                            if (_features.isEmpty)
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (context, i) =>
                                    _buildFeatureCard(i, _features[i]),
                              ),
                          ],
                        ],
                ...
                children: [
                        ...
                        suffixIcon: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () =>
                                  _regenerateEpicField(epic, 'title'),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _statusColor(epic.status).withValues(alpha: 0.1),
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: ['backlog', 'active', 'complete', 'cancelled']
                            .map((s) => DropdownMenuItem(
                                ...
                                child: Text(s,
                                    style: TextStyle(
                                        fontSize: 11, color: _statusColor(s)))))
                            .toList(),
                        onChanged: (v) {
                          if (v != null) {
                            epic.status = v;
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        _priorityColor(feature.priority).withValues(alpha: 0.1),
                    borderRadius: BorderRadius.circular(4),
                  ),
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: ['critical', 'high', 'medium', 'low']
                          .map((p) => DropdownMenuItem(
                              ...
                              child: Text(p,
                                  style: TextStyle(
                                      fontSize: 11, color: _priorityColor(p)))))
                          .toList(),
                      onChanged: (v) {
                        if (v != null) {
                          feature.priority = v;
  ...
  Widget _buildEmptyState(String message) {
    return Container(
      ...
      child: Center(
        child:
            Text(message, style: const TextStyle(color: _kMuted, fontSize: 14)),
      ),
    );
  }
