...
showNavigationButtons: false, onExportPdf: _exportPdf),
 const SizedBox(height: 20),
            ...
            ContextBanner.fromService(screenId: 'commerce_viability'),
 ...
 try {      await LaunchPhaseService.saveCommerceViability(
        projectId: _projectId!,
      ...
      PlanningPhaseContextService.instance.publishContext(
        PlanningContextBuilder.buildHypercareContext(projectData),
      );
    } catch (e) {
