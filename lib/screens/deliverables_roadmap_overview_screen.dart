...
class _DeliverablesRoadmapOverviewScreenState
  ...
  Map<DeliverableCategory, List<AggregatedDeliverable>>?
      _deliverablesByCategory;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          if (_deliverablesByCategory != null) _buildCategorySections(),
        ],
      ),
    );
  }
  ...
  Widget _buildStatisticsCards() {
    ...
    return Row(
      children: [
        Expanded(
            child: _buildStatCard('Total', stats.total.toString(), Icons.list)),
        Expanded(
            child: _buildStatCard('Completed', stats.completed.toString(),
                Icons.check_circle, Colors.green)),
        Expanded(
            child: _buildStatCard('In Progress', stats.inProgress.toString(),
                Icons.pending, Colors.orange)),
        Expanded(
            child: _buildStatCard(
                'At Risk', stats.atRisk.toString(), Icons.warning, Colors.red)),
        Expanded(
            child: _buildStatCard('Overdue', stats.overdue.toString(),
        ...
        for (final category in DeliverableCategory.values)
          if (_deliverablesByCategory![category]!.isNotEmpty)
            _buildCategorySection(
                category, _deliverablesByCategory![category]!),
      ],
    );
  }
  ...
  Widget _buildDeliverableTile(
      AggregatedDeliverable deliverable, bool showDivider) {
    return Column(
      children: [
        InkWell(
    ...
    return Row(
      children: [
        Icon(Icons.calendar_today,
            size: 12, color: isOverdue ? Colors.red : _kMuted),
        const SizedBox(width: 4),
        Text(
      ...
      sections: [
        ...
        PdfSection.text(
            ...
            projectData.planningNotes[
                    'planning_deliverables_roadmap_overview_notes'] ??
                'No data recorded.'),
      ],
    );
  }
