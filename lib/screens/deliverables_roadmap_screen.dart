      ...
      child: Column(
        ...
        children: [
          ...
          LaunchPhaseNavigation(
            backLabel:
                PlanningPhaseNavigation.backLabel('deliverables_roadmap'),
            nextLabel:
                PlanningPhaseNavigation.nextLabel('deliverables_roadmap'),
            onBack: () => PlanningPhaseNavigation.goToPrevious(
                context, 'deliverables_roadmap'),
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_deliverables_roadmap_notes'] ??
                'No data recorded.'),
      ],
    );
  }
