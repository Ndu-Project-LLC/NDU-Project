  ...
  await PdfExportHelper.exportScreenPdf(
    ...
    sections: [
      ...
      PdfSection.text(
          'Notes',
          projectData
                  .planningNotes['execution_plan_infrastructure_plan_screen'] ??
              'No data recorded.'),
    ],
  );
}
...
class ExecutionPlanInfrastructurePlanScreen extends StatelessWidget {
  ...
  static void open(BuildContext context) {
    context.push('/execution-plan-infrastructure-plan');
  }
          ...
          children: [
            ExecutionPlanHeader(
                ...
                onNext: () => PlanningPhaseNavigation.goToNext(
                    context, 'execution_plan_infrastructure_plan'),
                onExportPdf: () => _exportInfrastructurePlanPdf(context)),
            const SizedBox(height: 32),
            const SectionIntro(title: 'Execution Plan - Infrastructure Plan'),
