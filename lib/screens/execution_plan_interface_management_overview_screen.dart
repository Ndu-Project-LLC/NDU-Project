              ...
              child: _DoneButton(
                onPressed: () {
                  PlanningPhaseNavigation.goToNext(
                      context, 'execution_plan_interface_management_overview');
                },
              ),
            ),
              ...
              systems: [
                ...
                ...contractual.map((e) => _SystemCard(
                      title: e.boundary.trim().isNotEmpty
                          ? e.boundary.trim()
                          : 'Contract',
                      subtitle: e.partyA.trim().isNotEmpty
                          ? e.partyA.trim()
                          : 'Third party',
                      color: const Color(0xFFFFE4CC),
                    )),
              ...
              systems: organizational
                  .map((e) => _SystemCard(
                        title: e.boundary.trim().isNotEmpty
                            ...
                            : 'Interface',
                        subtitle:
                            '${e.partyA.trim().isNotEmpty ? e.partyA.trim() : "Party A"} ↔ ${e.partyB.trim().isNotEmpty ? e.partyB.trim() : "Party B"}',
