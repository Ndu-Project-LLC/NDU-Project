...
class _PlanningCardsSectionState extends State<_PlanningCardsSection> {
 ...
 // ─── Kanban card grid IDs ───────────────────────────────────────────────
 // Stable identifiers persisted to SharedPreferences so the user's
 ...
 void _onItemMovedBetweenSections(
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'projectGoals'),
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'successCriteriaItems'),
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'withinScopeItems'),
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'outOfScopeItems'),
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'assumptionItems'),
 ...
 onItemReceived: (itemId, sourceKey) => _onItemMovedBetweenSections(context, itemId, sourceKey, 'constraintItems'),
 ...
 updatedTarget.add(item as PlanningDashboardItem);
