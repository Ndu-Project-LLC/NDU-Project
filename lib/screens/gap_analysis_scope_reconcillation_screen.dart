...
class _InfoStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final projectName = projectData?.projectName.isNotEmpty == true
        ? projectData!.projectName
        : AppStrings.appName;
    final track = _resolveTrack(projectData?.overallFramework);
    final deliveryStage =
        _resolveDeliveryStage(projectData?.currentCheckpoint ?? 'initiation');
                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              final entry = _sortedEntries[idx];
                              final isLast = idx == _sortedEntries.length - 1;
                              return RepaintBoundary(
                                key: ValueKey('gap_entry_$idx'),
                                child: _GapEntryRow(
                                  entry: entry,
                                  onEdit: () => _showGapEntryEditor(context,
                                      existing: entry),
                                  onDelete: () =>
...
class _GapAnalysisRootCauseCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              final item = rootCauseThemes[idx];
                              final isLast = idx == rootCauseThemes.length - 1;
                              return RepaintBoundary(
                                key: ValueKey('root_cause_$idx'),
                                child: _RootCauseRow(
                                  item: item,
                                  onEdit: () => _showRootCauseEditor(context,
                                      existing: item),
                                  onDelete: () =>
          ...
          if (mitigationConfidence.isEmpty)
            const _EmptyPanel(label: 'No mitigation confidence entries yet.')
          else
            LayoutBuilder(
              builder: (context, constraints) {
                final tableWidth =
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              final item = mitigationConfidence[idx];
                              final isLast =
                                  idx == mitigationConfidence.length - 1;
                              return RepaintBoundary(
                                key: ValueKey('mitigation_$idx'),
                                child: _RootCauseRow(
                                  item: item,
                                  onEdit: () => _showMitigationEditor(context,
                                      existing: item),
                                  onDelete: () =>
  ...
  void _showMitigationEditor(BuildContext context, {_RootCauseItem? existing}) {
    _showInsightEditor(
      context,
      existing: existing,
                  ...
                  child: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: catColor.withValues(alpha: 0.18)),
                      ),
                      child: Text(
                        e.category,
                        textAlign: TextAlign.center,
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(_priorityIcon(e.stage),
                              size: 13, color: prioColor),
                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              ...
                              final isLast = idx == plans.length - 1;
                              return RepaintBoundary(
                                key: ValueKey('recon_plan_$idx'),
                                child: _ReconPlanRow(
                                  plan: plan,
                                  onEdit: () =>
  ...
  void _showPlanEditor(BuildContext context, {_PlanEntry? existing}) {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          title: Text(
              isEdit ? 'Edit Reconciliation Step' : 'Add Reconciliation Step'),
          content: SingleChildScrollView(
            child: SizedBox(
              width: 500,
              child: Column(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              final impact = impacts[idx];
                              final isLast = idx == impacts.length - 1;
                              return RepaintBoundary(
                                key: ValueKey('impact_$idx'),
                                child: _ImpactAssessmentRow(
                                  impact: impact,
                                  onEdit: () => _showImpactEditor(context,
                                      existing: impact),
                                  onDelete: () =>
  ...
  void _showImpactEditor(BuildContext context, {_ImpactRow? existing}) {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          title:
              Text(isEdit ? 'Edit Impact Assessment' : 'Add Impact Assessment'),
          content: SingleChildScrollView(
            child: SizedBox(
              width: 500,
              child: Column(
            ...
            child: Row(
              ...
              children: [
                  ...
                  child: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(
                            color: domainColor.withValues(alpha: 0.18)),
                      ),
                      child: Text(
                        i.domain,
                        textAlign: TextAlign.center,
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(_ratingIcon(i.rating),
                              size: 13, color: ratingColor),
                          const SizedBox(width: 5),
                          Flexible(
                            child: Text(
                              i.rating,
                ...
                SizedBox(
                  ...
                  child: Center(
                    child: Text(
                      i.financialExposure.trim().isEmpty
                          ? '—'
                          : i.financialExposure,
                      style: const TextStyle(
                        fontSize: 11,
      ...
      trailing: TextButton.icon(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                  'Workflow board is shown below in the Reconciliation workflow section.'),
            ...
            children: [
              ...
              if (items.isNotEmpty)
                ListView.builder(
                  ...
                  itemBuilder: (context, idx) {
                    return RepaintBoundary(
                      key: ValueKey('workflow_card_${items[idx].label}_$idx'),
                      child: _DraggableWorkflowCard(
                        step: items[idx],
                        accent: accent,
                        onDelete: onDelete,
                      ),
  ...
  Widget build(BuildContext context) {
    return _SectionShell(
      ...
      trailing: TextButton.icon(
        onPressed: () {
          onLessonsUpdated(
              [...lessons, 'New follow-up insight — click to edit']);
        },
...
class _PlanEntry {
  ...
  factory _PlanEntry.fromJson(Map<String, dynamic> json) {
    return _PlanEntry(
      ...
      completionPct:
          json['completionPct'] is int ? json['completionPct'] as int : null,
