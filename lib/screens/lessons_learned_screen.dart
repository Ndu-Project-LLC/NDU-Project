        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                PlanningPhaseHeader(
                    title: 'Lessons Learned', onExportPdf: _exportPdf),
            ...
            child: Row(
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  label: Text(
                      PlanningPhaseNavigation.backLabel('lessons_learned')),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.white,
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(
                      PlanningPhaseNavigation.nextLabel('lessons_learned')),
                  style: ElevatedButton.styleFrom(
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_lessons_learned_notes'] ??
                'No data recorded.'),
      ],
    );
  }
