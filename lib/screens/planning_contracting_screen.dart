...
List<_PlanningScopeOption> _planningScopeOptionsFromData(
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_contracting_notes'] ??
                'No data recorded.'),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        _SectionCard(
          ...
          subtitle:
              'Define the package, award, and approval approach for this project',
    ...
    return Wrap(
      ...
      children: const [
        ...
        _InlineInfoCard(
          title: 'Schedule Sync',
          detail:
              'Approved milestones should create schedule entries automatically.',
      ...
      child: StreamBuilder<List<ContractModel>>(
        ...
        builder: (context, snap) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) =>
                _PackagePlanningCard(contract: contracts[index]),
          );
        },
      ),
    );
            ...
            child: isSaving
                ? const SizedBox(
                    ...
                    child: CircularProgressIndicator(
                        strokeWidth: 2, color: _kFabOnYellow))
                : const Text('Create',
...
Future<void> _showEditPackageDialog(
  ...
  final summaryCtrl = TextEditingController(
      text: contract.packageSummary ?? contract.description);
              ...
              child: Column(
                ...
                children: [
                  DropdownButtonFormField<String?>(
                    value:
                        scopeOptions.any((item) => item.id == selectedScopeId)
                            ? selectedScopeId
                            : null,
                    isExpanded: true,
                    ...
                    onChanged: (value) =>
                        setDialog(() => selectedScopeId = value),
                    decoration: const InputDecoration(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(
                                  value: 'Reimbursable (Time & Materials)',
                                  child:
                                      Text('Reimbursable (Time & Materials)')),
                            ],
                            onChanged: (value) => setDialog(() =>
                                selectedContractType = value ?? 'Not Sure'),
                            decoration: const InputDecoration(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () async {
                            final picked =
                                await pickDate(plannedExecutionStart);
                            if (picked != null) {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content:
                        Text('Saved package updates for ${contract.name}.'),
...
class _TenderSetupTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final initialText = ProjectDataHelper.getData(context)
        .planningNotes['planning_tender_setup'];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _SectionCard(
      ...
      child: StreamBuilder<List<ContractModel>>(
        ...
        builder: (context, snap) {
          ...
          final procurementIssuedContracts = contracts
              ...
              .toList();
          final procurementIssuedValue =
              procurementIssuedContracts.fold<double>(
                  0.0,
                  (total, contract) =>
                      total +
                      (contract.recommendedAwardValue ??
              ...
              Wrap(
                ...
                children: [
                  ...
                  _StatCard(
                      ...
                      color: const Color(0xFF7C3AED),
                      supporting:
                          '${procurementIssuedContracts.length} packages'),
                ],
              ),
              const SizedBox(height: 20),
              const _SectionCard(
              ...
              _SectionCard(
                ...
                child: contracts.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemCount: contracts.length,
                        itemBuilder: (context, index) =>
                            _HandoffReadinessCard(contract: contracts[index]),
                      ),
              ),
            ],
          );
...
Future<void> _issuePackageToProcurement(
  ...
  planningRfq ??=
      rfqs.where((rfq) => rfq.linkedScopeId == contract.id).firstOrNull;
  if (planningRfq == null) {
    return;
  }
  ...
  final procurementRfq = procurement_models.RfqModel(
    ...
    category:
        contract.discipline.isEmpty ? 'Contract Package' : contract.discipline,
...
class _HandoffReadinessCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final awardValue =
        contract.recommendedAwardValue ?? contract.estimatedValue;
    final alreadySent =
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      ready ? const Color(0xFFDCFCE7) : const Color(0xFFFEF3C7),
                  borderRadius: BorderRadius.circular(999),
                ),
                child: Text(
          ...
          Row(
            ...
            children: [
              if (!ready && ((contract.linkedFepScopeId ?? '').trim().isEmpty))
                TextButton(
                  onPressed: () => _showEditPackageDialog(context, contract),
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    await _showEvaluationDialog(
                      ...
                      contract,
                      rfqs
                          .where((rfq) => rfq.linkedScopeId == contract.id)
                          .toList(),
                    );
                  },
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                    alreadySent ? 'Sent to Execution' : 'Send to Execution'),
                style: ElevatedButton.styleFrom(
                  backgroundColor: _kBrandYellow,
                  foregroundColor: Colors.white,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        RepaintBoundary(
          child: StreamBuilder<List<PlanningRfq>>(
...
void _showRfpDialog(
  ...
  final scopeCtrl = TextEditingController(text: existingRfq?.scopeOfWork ?? '');
  ...
  List<EvaluationCriteria> criteria = existingRfq != null
      ...
      : [
          EvaluationCriteria(
              name: 'Technical Compliance', weight: 40, category: 'Technical'),
          EvaluationCriteria(
              name: 'Commercial Offer', weight: 35, category: 'Commercial'),
          EvaluationCriteria(
              name: 'Delivery Plan', weight: 25, category: 'Commercial'),
        ];
      ...
      builder: (dCtx, setDialog) => AlertDialog(
                  ...
                  child: FutureBuilder<List<ContractModel>>(
                    ...
                    builder: (context, snap) {
                      ...
                      return DropdownButtonFormField<String>(
                        value:
                            linkedPackageId.isNotEmpty ? linkedPackageId : null,
                        isExpanded: true,
                        items: packages
                            ...
                            .toList(),
                        onChanged: (value) =>
                            setDialog(() => linkedPackageId = value ?? ''),
                        decoration: const InputDecoration(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                ...
                if (linkedPackageId.isNotEmpty) {
                  ...
                  await _upsertScheduleMilestoneActivity(
                    context: context,
                    milestoneId: _scheduleMilestoneId(
                        linkedPackageId, 'pre_bid_meeting'),
            ...
            style: ElevatedButton.styleFrom(
                backgroundColor: _kBrandYellow, foregroundColor: Colors.white),
            child: isSaving
                ? const SizedBox(
                    width: 20,
                    height: 20,
...
String _formatCriteriaEditor(List<EvaluationCriteria> criteria) {
  return criteria
      .map((item) =>
          '${item.name}:${item.weight.toStringAsFixed(0)}:${item.category}')
      .join('\n');
}
...
List<EvaluationCriteria> _parseCriteriaEditor(String rawText) {
  return rawText
    ...
    final category = parts.length > 2 && parts[2].trim().isNotEmpty
        ? parts[2].trim()
        : 'Technical';
...
class _EvaluationContractRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final criteria =
        selectedRfq?.evaluationCriteria ?? const <EvaluationCriteria>[];
      ...
      title: Row(
        children: [
          ...
          _StatusChip(
            ...
            color: scores.isEmpty ? const Color(0xFF64748B) : _kBrandYellow,
          ),
          const SizedBox(width: 8),
          TextButton.icon(
...
Future<void> _showEvaluationDialog(
  ...
  String selectedRfqId = _selectedRfqForContract(contract, rfqs)?.id ?? '';
  final initialCriteria =
      _selectedRfqForContract(contract, rfqs)?.evaluationCriteria ??
            ...
            onPressed: () async {
              ...
              final normalizedPmReview =
                  pmReview == 'Approved' && technicalGate != 'Passed Technical'
                      ? 'Pending'
                      : pmReview;
              final normalizedSponsorApproval = sponsorApproval == 'Approved' &&
                      (technicalGate != 'Passed Technical' ||
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content:
                      Text('Saved evaluation updates for ${contract.name}.'),
                  backgroundColor: const Color(0xFF16A34A),
                ),
              );
            },
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        ...vendors.map((vendor) {
          final screening = screeningMap[vendor] ??
              VendorTechnicalScreening(vendorName: vendor);
          return Container(
            margin: const EdgeInsets.only(bottom: 12),
            padding: const EdgeInsets.all(12),
        ...
        builder: (context, snap) {
          ...
          if (contracts.isEmpty) {
            return const _SectionCard(
              ...
              child: _EmptyPanel(
                  'Add contracts first to configure administration.'),
            );
          }
          return ListView.builder(
            shrinkWrap: true,
            ...
            itemCount: contracts.length,
            itemBuilder: (context, index) =>
                _AdminContractCard(contract: contracts[index]),
          );
        },
      ),
    );
      ...
      child: StreamBuilder<List<ContractModel>>(
        ...
        builder: (context, snap) {
          ...
          return ListView.builder(
            ...
            itemCount: contracts.length,
            itemBuilder: (context, index) =>
                _NegotiationContractCard(contract: contracts[index]),
          );
        },
      ),
    );
                  ...
                  children: [
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: 'Not Set', child: Text('Not Set')),
                          DropdownMenuItem(
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: const [
                          ...
                          DropdownMenuItem(
                              value: 'Agreed', child: Text('Agreed')),
                          DropdownMenuItem(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Saved negotiation plan for ${contract.name}.'),
                  backgroundColor: const Color(0xFF16A34A),
                ),
              );
            },
    ...
    return RepaintBoundary(
      child: StreamBuilder<List<ContractModel>>(
        ...
        builder: (context, snap) {
          ...
          final totalBase =
              allContracts.fold<double>(0.0, (t, c) => t + c.estimatedValue);
            ...
            children: [
              ...
              _SectionCard(
                ...
                child: allContracts.isEmpty
                    ? const _EmptyPanel(
                        'No contracts to show budget breakdown.')
                    : Column(
                        children: [
                          _SearchField(
          ...
          child: _TableFieldShell(
            child: _NumberInputCell(
              ...
              onChanged: (value) {
                ...
                onChangedContingencyPercent(
                    projectId, contract.id, base, newPct);
              },
            ),
          ),
        ),
...
class _CriteriaRowState extends State<_CriteriaRow> {
  ...
  void initState() {
    ...
    _weightController =
        TextEditingController(text: widget.criterion.weight.toStringAsFixed(0));
  }
