...
class ProjectCharterScreen extends StatefulWidget {
  ...
  static void open(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute<void>(builder: (_) => const ProjectCharterScreen()),
    );
  }
...
class _ProjectCharterScreenState extends State<ProjectCharterScreen> {
  ...
  Future<void> _ensureCharterContent() async {
    ...
    final needsOverview =
        _projectData!.businessCase.trim().isEmpty &&
  ...
  void _navigateToProjectDetails() {
    try {
      Navigator.of(context).push(
        MaterialPageRoute<void>(builder: (_) => const ProjectDetailsScreen()),
      );
    } catch (e) {
  ...
  void _navigateToBusinessCase() {
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute<void>(
          builder: (_) =>
              CostAnalysisScreen(notes: data?.notes ?? '', solutions: const []),
        ),
      );
    } catch (e) {
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_projectData != null &&
                              _projectData!.charterProjectManagerName
                                  .trim()
                                  .isEmpty) ...[
                            AssignManagerWalkthrough(
                              onAssignTapped: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Tap the "PROJECT MANAGER" card below to assign a manager.',
                                    ),
