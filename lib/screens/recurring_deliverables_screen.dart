...
class _RecurringDeliverablesScreenState
  ...
  Future<void> _autoGenerateIfNeeded() async {
    ...
    try {
      final String contextText = ExecutionPhaseAiSeed.buildContext(context,
      ...
      final generated = await ExecutionPhaseAiSeed.generateEntries(
        ...
        sections: const {
          'recurringDeliverables':
              'Recurring deliverables, checkpoints, and review rituals',
        },
        itemsPerSection: 3,
      );
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('AI draft recurring deliverables added.')),
        );
      }
    } catch (e) {
      if (mounted) {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData
                    .planningNotes['planning_recurring_deliverables_notes'] ??
                'No data recorded.'),
      ],
    );
  }
