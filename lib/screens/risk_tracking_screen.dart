...
class _RiskTrackingScreenState extends State<RiskTrackingScreen> {
  ...
  final List<_EscalationReadiness> _escalations = [
    ...
    _EscalationReadiness(
      ...
      level: 'L2-Management',
      triggerCondition:
          'Penetration retest overdue or critical vulnerability detected',
  ...
  List<_MitigationPlan> _plans = [
    _MitigationPlan(
      ...
      riskId: 'R-001',
      strategy:
          'Vendor API stability — failover circuit breaker implementation',
      owner: 'A. Mwanza',
    ...
    _MitigationPlan(
      ...
      riskId: 'R-002',
      strategy:
          'Regulatory review delay — parallel submission track with legal',
      owner: 'B. Tembo',
      category: 'Compliance',
      status: 'At risk',
      coverage: 0.42,
    ...
    _MitigationPlan(
      ...
      riskId: 'R-003',
      strategy:
          'Data quality regression — automated validation pipeline deployment',
      owner: 'C. Banda',
      category: 'Data team',
      status: 'On track',
      coverage: 0.64,
    ...
    _MitigationPlan(
      ...
      riskId: 'R-004',
      strategy:
          'Security posture drift — scheduled penetration retest & patch cycle',
      owner: 'D. Phiri',
    ...
    _MitigationPlan(
      ...
      riskId: 'R-005',
      strategy:
          'Budget volatility — revised forecast with contingency allocation',
      owner: 'E. Zulu',
      category: 'Finance',
      status: 'Not started',
      coverage: 0.0,
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => _autoGenerateIfNeeded());
  }
  ...
  Widget _buildRowActions(
    ...
    return Row(
      ...
      children: [
        ...
        _iconButton(Icons.delete_outline, 'Delete', onDelete,
            isDestructive: true),
      ],
    );
  }
  ...
  Widget _buildMitigationPanel() {
    return _PanelShell(
      ...
      subtitle:
          'Execution readiness by risk program — aligned to ISO 31000 & PMI Risk Practice',
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          _actionButton(Icons.add, 'Add plan',
              onPressed: _openAddMitigationDialog),
        ],
      ),
  ...
  Widget _buildSignalsPanel() {
    return _PanelShell(
      title: 'Risk signals',
      subtitle:
          'Early warnings, leading/lagging indicators, and momentum shifts — COSO ERM aligned',
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          _actionButton(Icons.add, 'Add signal',
              onPressed: _openAddSignalDialog),
        ],
      ),
  ...
  Widget _buildEscalationPanel() {
    return _PanelShell(
      ...
      subtitle:
          'Escalation paths, decision authority, and sponsor alignment — ISO 31000 & ITIL aligned',
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          _actionButton(Icons.add, 'Add escalation',
              onPressed: _openAddEscalationDialog),
        ],
      ),
                      ...
                      children: [
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              labelText: 'Escalation ID',
                              hintText: 'e.g., ESC-005'),
                        ...
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              labelText: 'Escalation event',
                              hintText:
                                  'e.g., Executive sync — critical unblock'),
                          validator: (v) =>
                        ...
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              hintText:
                                  'e.g., SLA breach or threshold exceeded'),
                          maxLines: 2,
                          validator: (v) =>
                              v == null || v.trim().isEmpty ? 'Required' : null,
                        ),
                        ...
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              hintText: 'e.g., CTO / Steering Committee'),
                        ),
                        const SizedBox(height: 12),
                        DropdownButtonFormField<String>(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Slider(
                                ...
                                onChanged: (v) =>
                                    setDialogState(() => readinessValue = v),
                              ),
                            ),
                        ...
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              labelText: 'Response window',
                              hintText: 'e.g., 4 hrs, 24 hrs'),
                        ),
                        const SizedBox(height: 12),
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              hintText: 'What decision is needed?'),
                          maxLines: 2,
                        ),
                      ],
                    ),
                        ...
                        _escalations.add(_EscalationReadiness(
                          ...
                          responsibleParty:
                              responsibleController.text.trim().isEmpty
                                  ? 'TBD'
                                  : responsibleController.text.trim(),
                          escalationTarget: targetController.text.trim().isEmpty
                              ? 'TBD'
                              : targetController.text.trim(),
                          status: selectedStatus,
                          readiness: readinessValue,
                          responseWindow: windowController.text.trim().isEmpty
                              ? '24 hrs'
                              : windowController.text.trim(),
                          decisionRequired:
  ...
  void _openEditEscalationDialog(_EscalationReadiness esc) {
    ...
    final responsibleController =
        TextEditingController(text: esc.responsibleParty);
    ...
    final decisionController =
        TextEditingController(text: esc.decisionRequired);
    final formKey = GlobalKey<FormState>();
                ...
                ElevatedButton(
                  onPressed: () {
                    if (formKey.currentState?.validate() ?? false) {
                      setState(() {
                        final idx =
                            _escalations.indexWhere((e) => e.id == esc.id);
                        if (idx != -1) {
  ...
  void _deleteEscalation(_EscalationReadiness esc) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content:
            Text('Are you sure you want to delete ${esc.id}: "${esc.event}"?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('Cancel')),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      VoiceTextFormField(
                        controller: nextReviewController,
                        decoration:
                            const InputDecoration(labelText: 'Next review'),
                      ),
                    ],
                  ),
                ),
  ...
  void _deleteRisk(_RiskItem risk) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            'Are you sure you want to delete risk ${risk.id}: "${risk.title}"?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('Cancel')),
                      ...
                      children: [
                        ...
                        VoiceTextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              hintText: 'Describe the mitigation approach'),
                          maxLines: 2,
                          validator: (v) =>
                              v == null || v.trim().isEmpty ? 'Required' : null,
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Slider(
                                ...
                                onChanged: (v) =>
                                    setDialogState(() => coverageValue = v),
                              ),
                            ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            if (v != null)
                              setDialogState(() => selectedEffectiveness = v);
                          },
                          decoration:
                              const InputDecoration(labelText: 'Effectiveness'),
                        ),
                        const SizedBox(height: 12),
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            if (v != null)
                              setDialogState(() => selectedResidual = v);
                          },
                          decoration:
                              const InputDecoration(labelText: 'Residual risk'),
                        ),
                      ],
                    ),
                  ),
                    ...
                    if (formKey.currentState?.validate() ?? false) {
                      setState(() {
                        _plans.add(_MitigationPlan(
                          id: idController.text.trim(),
                          riskId: riskIdController.text.trim().isEmpty
                              ? '—'
                              : riskIdController.text.trim(),
                          ...
                          targetDate: targetDateController.text.trim().isEmpty
                              ? 'TBD'
  ...
  void _deleteMitigationPlan(_MitigationPlan plan) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            'Are you sure you want to delete ${plan.id}: "${plan.strategy.substring(0, plan.strategy.length > 50 ? 50 : plan.strategy.length)}..."?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('Cancel')),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        VoiceTextFormField(
                          controller: titleController,
                          decoration:
                              const InputDecoration(labelText: 'Signal name'),
                          validator: (v) =>
                              v == null || v.trim().isEmpty ? 'Required' : null,
                        ),
                        const SizedBox(height: 12),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (v) {
                            if (v != null)
                              setDialogState(() => selectedConfidence = v);
                          },
                          decoration: const InputDecoration(
                    ...
                    if (formKey.currentState?.validate() ?? false) {
                      setState(() {
                        _signals.add(_RiskSignal(
                          ...
                          linkedRisk: linkedRiskController.text.trim().isEmpty
                              ? '—'
                              : linkedRiskController.text.trim(),
                          trend: selectedTrend,
                          detectedDate:
                              DateTime.now().toIso8601String().substring(0, 10),
                        ));
  ...
  void _openEditSignalDialog(_RiskSignal signal) {
    ...
    final descriptionController =
        TextEditingController(text: signal.description);
                ...
                ElevatedButton(
                  onPressed: () {
                    if (formKey.currentState?.validate() ?? false) {
                      setState(() {
                        final idx =
                            _signals.indexWhere((s) => s.id == signal.id);
                        if (idx != -1) {
  ...
  void _deleteSignal(_RiskSignal signal) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            'Are you sure you want to delete ${signal.id}: "${signal.title}"?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('Cancel')),
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_risk_tracking_notes'] ??
                'No data recorded.'),
      ],
    );
  }
