          ...
          : isMobile
              ? ListView.builder(
                  ...
                  itemBuilder: (context, i) => RepaintBoundary(
                    key: ValueKey('risk_card_$i'),
                    child: _buildRiskCard(_filteredRisks[i]),
                  ),
                )
              : _buildRiskTable(),
    );
    ...
    return _buildSectionCard(
      ...
      child: _signals.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, i) => RepaintBoundary(
                key: ValueKey('signal_card_$i'),
                child: _buildSignalCard(_signals[i]),
              ),
            ),
    );
  }
    ...
    return _buildSectionCard(
      ...
      child: _mitigations.isEmpty
          ...
          : ListView.builder(
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              itemCount: _mitigations.length,
              itemBuilder: (context, i) => RepaintBoundary(
                key: ValueKey('mitigation_card_$i'),
                child: _buildMitigationCard(_mitigations[i]),
              ),
            ),
    );
  }
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData
                    .planningNotes['planning_risk_tracking_workspace_notes'] ??
                'No data recorded.'),
      ],
    );
  }
