    ...
    return entries
        .map((entry) {
          ...
          return _AcceptanceTagItem(
            ...
            status: status,
            category:
                _signalCategories.contains(category) ? category : 'Sponsor',
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                    flex: 3, child: Text('Work Package', style: _headerStyle)),
          ...
          if (_workPackages.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) => RepaintBoundary(
                key: ValueKey('work_package_row_$index'),
                child: _buildWorkPackageDisplayRow(_workPackages[index], index),
              ),
            ),
          const SizedBox(height: 10),
          // CRUD action bar
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text(
              item.baselineDate != null ? _formatDate(item.baselineDate!) : '—',
              style: const TextStyle(fontSize: 12, color: Color(0xFF374151)),
            ),
          ),
          // Actual Date
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight:
                    _isOverdue(item) ? FontWeight.w600 : FontWeight.normal,
              ),
            ),
          ),
          // % Complete
                  ...
                  children: [
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => baselineDate = d),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => actualDate = d),
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                    flex: 3, child: Text('Checkpoint', style: _headerStyle)),
          ...
          if (_acceptanceCheckpoints.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) => RepaintBoundary(
                key: ValueKey('checkpoint_row_$index'),
                child: _buildCheckpointDisplayRow(
                    _acceptanceCheckpoints[index], index),
              ),
            ),
          const SizedBox(height: 10),
          Row(
                  ...
                  children: [
                    Expanded(
                      child: LaunchModalDateField(
                        label: 'Due Date',
                        initialDate: dueDate,
                        onPicked: (d) => setDialogState(() => dueDate = d),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => signOffDate = d),
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(flex: 2, child: Text('Status', style: _headerStyle)),
                Expanded(
                    flex: 2, child: Text('Verified By', style: _headerStyle)),
          ...
          if (_acceptanceTags.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) => RepaintBoundary(
                key: ValueKey('acceptance_tag_row_$index'),
                child: _buildAcceptanceTagDisplayRow(
                    _acceptanceTags[index], index),
              ),
            ),
          const SizedBox(height: 10),
          Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => dateVerified = d),
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                    flex: 3,
                    child: Text('Change Description', style: _headerStyle)),
                Expanded(flex: 1, child: Text('Type', style: _headerStyle)),
                Expanded(flex: 1, child: Text('Impact', style: _headerStyle)),
                Expanded(
                    flex: 2, child: Text('Requested By', style: _headerStyle)),
                Expanded(
                    flex: 2, child: Text('Date Raised', style: _headerStyle)),
                Expanded(flex: 2, child: Text('Status', style: _headerStyle)),
                Expanded(flex: 1, child: Text('', style: _headerStyle)),
              ],
            ),
          ...
          if (_scopeChanges.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) => RepaintBoundary(
                key: ValueKey('scope_change_row_$index'),
                child: _buildScopeChangeDisplayRow(_scopeChanges[index], index),
              ),
            ),
          const SizedBox(height: 10),
          Row(
                  ...
                  children: [
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => dateRaised = d),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: LaunchModalDateField(
                        ...
                        onPicked: (d) => setDialogState(() => decisionDate = d),
                      ),
                    ),
                  ],
                ),
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_scope_completion_notes'] ??
                'No data recorded.'),
      ],
    );
  }
