...
class _TeamTrainingAndBuildingScreenState
  ...
  Future<void> _addActivity(
    ...
    await _editActivity(context, newActivity, isNew: true);
  }
  ...
  Future<void> _editActivity(
        ...
        builder: (context, setDialogState) {
          ...
          return PremiumEditDialog(
            ...
            onSave: () async {
              ...
              await _saveActivitiesSilently(rootContext, updated);
            },
            children: [
    ...
    autoSaveDebounce?.cancel();
    if (!didExplicitSave && !isNew && rootContext.mounted) {
      await _persistActivityDraft(rootContext, buildDraft());
    }
          ...
          return LaunchModalShell(
            ...
            body: Column(
              ...
              children: [
                ...
                CheckboxListTile(
                  value: mandatory,
                  onChanged: (v) => setDialogState(() => mandatory = v == true),
...
''';
  ...
  Future<void> _addOnboardingTemplate(BuildContext context) async {
    ...
    final projectSpec = _resourceButtons
        .where((button) => button.id == 'project_onboarding')
        .firstOrNull;
    final teamSpec = _resourceButtons
        .where((button) => button.id == 'team_vacation')
        .firstOrNull;
    final meetingsSpec =
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData
                    .planningNotes['planning_team_training_building_notes'] ??
                'No data recorded.'),
      ],
    );
  }
