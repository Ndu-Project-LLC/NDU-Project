...
class _TechnicalAlignmentScreenState extends State<TechnicalAlignmentScreen> {
                          ...
                          children: [
                            ...
                            const Expanded(
                                child: Column(
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                      'Define a new delivery model with alignment evidence and exit standards',
                                      style: TextStyle(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16),
                              _buildDialogField(
                                  controller: bestFitController,
                                  label: 'Best-Fit Use Case',
                                  hint:
                                      'e.g. Predictable, well-defined projects',
                              ...
                              _buildDialogField(
                                  ...
                                  hint:
                                      'e.g. Charter approval, traceability matrix',
                              ...
                              _buildDialogField(
                                  ...
                                  hint:
                                      'e.g. Phase-gate reviews, change control board',
                                  icon: Icons.security_outlined,
                                  maxLines: 2),
                              const SizedBox(height: 16),
                              _buildDialogField(
                                  controller: exitStandardController,
                                  label: 'Exit Standard',
                                  hint:
                                      'e.g. All phase-gate criteria met, sign-off',
                              ...
                              Container(
                                ...
                                child: Row(children: [
                                  ...
                                  const Expanded(
                                      child: Text(
                                          'KAZ AI can generate model suggestions from your project context',
                                          style: TextStyle(
                                              fontSize: 12,
                            ...
                            ElevatedButton.icon(
                              onPressed: () {
                                if (formKey.currentState?.validate() ?? false) {
                                  final newModel = _MethodologyStandard(
                                      model: modelController.text.trim(),
                                      bestFit: bestFitController.text.trim(),
                                      evidence: evidenceController.text.trim(),
                                      controls: controlsController.text.trim(),
                                      exitStandard:
                                          exitStandardController.text.trim());
                                  Navigator.of(dialogContext).pop();
                                  setState(() {
                                    _methodologyStandards.add(newModel);
                                    _editingMethodologyRows
                                        .add(_methodologyStandards.length - 1);
                                    _scheduleSave();
                                  });
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          content: Text(
                                              '${newModel.model} added to delivery models'),
                                          backgroundColor:
  ...
  Widget _buildDialogField(
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        Icon(icon, size: 14, color: const Color(0xFFB8860B)),
  ...
  List<String> _registerOwnerOptions() {
    final provider = ProjectDataInherited.maybeOf(context);
    final teamOwners = (provider?.projectData.teamMembers ?? const [])
        .map((m) => m.name.trim())
                    ...
                    for (var i = 0; i < fields.length; i++) ...[
                      ...
                      if (fields[i].options != null) ...[
                        Builder(builder: (_) {
                          ...
                          final selected = raw.isEmpty || !options.contains(raw)
                              ? options.first
                              : raw;
                          return DropdownButtonFormField<String>(
                            ...
                            items: options
                                ...
                                .toList(),
                            validator: (v) =>
                                fields[i].isRequired && (v == null || v.isEmpty)
                        ...
                        TextFormField(
                          ...
                          decoration: _techAlignDialogFieldDecoration(
                              hint: fields[i].hint),
                          validator: (v) => fields[i].isRequired &&
              ...
              children: [
                  ...
                  child: const Row(
                    children: [
                      Expanded(
                          flex: 2,
                          child: Text('Model',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Best-fit Use',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Required Alignment Evidence',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Technical Control Focus',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Exit Standard',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 1,
                ...
                ..._methodologyStandards.asMap().entries.map((entry) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          idx.isEven ? Colors.white : const Color(0xFFFAFBFD),
                          ...
                          child: Row(
                            ...
                            children: [
                                    ...
                                    try {
                                      final projectData =
                                          ProjectDataInherited.maybeOf(context)
                                              ?.projectData;
                                      final projectContext = ProjectDataHelper
                                          .buildProjectContextScan(
                                        projectData ?? ProjectDataModel(),
                                        sectionLabel:
                                            'Technical Alignment - Delivery Model',
                                      );
                              ...
                              InkWell(
                                onTap: () async {
                                  final confirmed =
                                      await _confirmDelete('delivery model');
                                  if (!confirmed) return;
                                  setState(() {
                                    _methodologyStandards.removeAt(idx);
                                    _shiftEditingRowsAfterDelete(
                                        _editingMethodologyRows, idx);
                                    _scheduleSave();
                                  });
                                },
        ...
        child: InkWell(
          onTap: isGenerating
              ...
              : () async {
                  ...
                  try {
                    final projectData =
                        ProjectDataInherited.maybeOf(context)?.projectData;
        ...
        builder: (ctx, setDState) => AlertDialog(
          title: Row(children: [
            Icon(isEdit ? Icons.edit_outlined : Icons.add_circle_outline,
                size: 20, color: const Color(0xFFB8860B)),
            const SizedBox(width: 8),
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Expanded(
                          flex: 2,
                          child: Text('Control Domain',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('What Must Be True',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Evidence To Attach',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 2,
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (!confirmed) return;
                                  setState(() {
                                    _readinessGateItems.removeAt(idx);
                                    _shiftEditingRowsAfterDelete(
                                        _editingReadinessRows, idx);
                                    _scheduleSave();
                                  });
                                },
                                child: const Icon(Icons.delete_outline,
  ...
  void _showReadinessGateDialog({_ReadinessGateItem? existing, int? index}) {
    final isEdit = existing != null;
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDState) => AlertDialog(
          title: Row(children: [
            ...
            const SizedBox(width: 8),
            Text(isEdit ? 'Edit Gate Item' : 'Add Gate Item',
                style: const TextStyle(fontSize: 16)),
          ]),
          content: SizedBox(
            width: 560,
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Expanded(
                          flex: 2,
                          child: Text('Trace Object',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 3,
                          child: Text('Alignment Question',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 2,
                      ...
                      Expanded(
                          flex: 2,
                          child: Text('Waterfall Evidence',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 2,
                          child: Text('Agile / Hybrid Evidence',
                              style: _dmHeaderStyle,
                              textAlign: TextAlign.center)),
                      Expanded(
                          flex: 1,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  final confirmed =
                                      await _confirmDelete('traceability item');
                                  if (!confirmed) return;
                                  setState(() {
                                    _traceabilityItems.removeAt(idx);
                                    _shiftEditingRowsAfterDelete(
                                        _editingTraceabilityRows, idx);
                                    _scheduleSave();
                                  });
                                },
                                child: const Icon(Icons.delete_outline,
  ...
  void _showTraceabilityDialog({_TraceabilityItem? existing, int? index}) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Row(children: [
          Icon(isEdit ? Icons.edit_outlined : Icons.add_circle_outline,
              size: 20, color: const Color(0xFF0F766E)),
          const SizedBox(width: 8),
          Text(isEdit ? 'Edit Trace Item' : 'Add Trace Item',
              style: const TextStyle(fontSize: 16)),
        ]),
        content: SizedBox(
          width: 560,
    ...
    return _DeliveryModelPanelShell(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildScrollableTableSection(
            columns: const [
              _TableColumn(label: 'Requirement Area', flex: 3, minWidth: 240),
              _TableColumn(label: 'Technical Approach', flex: 5, minWidth: 360),
            ...
            bodyBuilder: (bc) => _mappings.isEmpty
                ? _buildEmptyTableState(
                    message:
                        'No requirement mappings yet. Add the first mapping.',
                ...
                : _buildScrollableTableBody(
                    columns: const [
                      _TableColumn(
                          label: 'Requirement Area', flex: 3, minWidth: 240),
                      _TableColumn(
                          label: 'Technical Approach', flex: 5, minWidth: 360),
                      _TableColumn(label: 'Status', flex: 2, minWidth: 150),
                      _TableColumn(
                          label: 'Actions',
                          flex: 1,
        ...
        children: [
          ...
          _buildScrollableTableSection(
            ...
            bodyBuilder: (bc) => _constraints.isEmpty
                ? _buildEmptyTableState(
                    message:
                        'No constraints captured yet. Add the first guardrail.',
                    actionLabel: 'Add constraint',
                    onAction: _addConstraintRow,
                  )
                : _buildScrollableTableBody(
          ...
          _buildScrollableTableSection(
            ...
            bodyBuilder: (bc) => _mappings.isEmpty
                ...
                : _buildScrollableTableBody(
                    ...
                    rowCount: _mappings.length,
                    rowBuilder: (i) => _buildMappingRow(_mappings[i],
          ...
          children: [
            ...
            if (!compact) ...[
              ...
              OutlinedButton.icon(
                ...
                label: Text(actionLabel, softWrap: true),
                style: OutlinedButton.styleFrom(
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_technical_alignment_notes'] ??
                'No data recorded.'),
      ],
    );
  }
