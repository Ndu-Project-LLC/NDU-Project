...
class _TechnicalDebtManagementScreenState
        ...
        builder: (context, constraints) {
          ...
          return Column(
            ...
            children: [
              // Header row
              Container(
                padding: const EdgeInsets.all(isNarrow ? 10 : 12),
                decoration: const BoxDecoration(
              ...
              if (_debtItems.isEmpty)
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final item = _debtItems[index];
                    return RepaintBoundary(
                      key: ValueKey('debt_item_row_$index'),
                      child: Container(
                        padding: const EdgeInsets.all(isNarrow ? 10 : 12),
  ...
  Future<void> _showDebtItemDialog({DebtItem? existing}) async {
              ...
              child: Column(
                ...
                children: [
                  ...
                  VoiceTextField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Target / Due'),
                  ),
                ],
              ),
            ),
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (id.isEmpty || title.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text('ID and Item are required.')),
                    );
                    return;
                  }
  ...
  Future<void> _showRemediationTrackDialog({
    int? displayIndex,
    ...
    try {
                  ...
                  children: [
                    ...
                    VoiceTextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        helperText:
                            'Brief description of what this lane covers.',
                      ),
                    ),
                    const SizedBox(height: 16),
                    VoiceTextField(
                    ...
                    VoiceTextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        helperText:
                            'What evidence proves exit criteria are met?',
                      ),
                    ),
                    const SizedBox(height: 16),
                    VoiceTextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        helperText:
                            'Who owns this and how often is it reviewed?',
                      ),
                    ),
                    const SizedBox(height: 20),
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Risk color'),
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (label.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text('Priority lane is required.')),
                    );
                    return;
                  }
      ...
      exitCriteriaController.dispose();
      evidenceController.dispose();
      ownerCadenceController.dispose();
    }
  }
  ...
  Future<void> _showRootCauseDialog({
    int? displayIndex,
                  ...
                  children: [
                    ...
                    VoiceTextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        helperText:
                            'What coverage model defines accountability?',
                      ),
                    ),
                    const SizedBox(height: 16),
                    VoiceTextField(
      ...
      sections: [
        ...
        PdfSection.text(
            ...
            projectData.planningNotes[
                    'planning_technical_debt_management_notes'] ??
                'No data recorded.'),
      ],
    );
  }
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => RepaintBoundary(
                        key: ValueKey('governance_row_$index'),
                        child: _GovernanceBodyRow(
                          columns: columns,
                          cells: rows[index],
