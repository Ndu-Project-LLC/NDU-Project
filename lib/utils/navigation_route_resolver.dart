...
class NavigationRouteResolver {
  ...
  static const Map<String, String> _checkpointUrls = {
    'business_case': '/${AppRoutes.initiationPhase}',
    'potential_solutions': '/${AppRoutes.potentialSolutions}',
    'risk_identification': '/${AppRoutes.riskIdentification}',
    'it_considerations': '/${AppRoutes.itConsiderations}',
    'infrastructure_considerations': '/${AppRoutes.infrastructureConsiderations}',
    'core_stakeholders': '/${AppRoutes.coreStakeholders}',
    'cost_analysis': '/${AppRoutes.costAnalysis}',
    'preferred_solution_analysis': '/${AppRoutes.preferredSolutionAnalysis}',
    'fep_summary': '/${AppRoutes.fepSummary}',
    'fep_requirements': '/${AppRoutes.fepRequirements}',
    'fep_risks': '/${AppRoutes.fepRisks}',
    'fep_opportunities': '/${AppRoutes.fepOpportunities}',
    'fep_contract_vendor_quotes': '/${AppRoutes.fepVendorQuotes}',
    'fep_procurement': '/${AppRoutes.fepProcurement}',
    'fep_security': '/${AppRoutes.fepSecurity}',
    'fep_allowance': '/${AppRoutes.fepAllowance}',
    'fep_milestone': '/${AppRoutes.fepMilestone}',
    'project_charter': '/${AppRoutes.projectCharter}',
    'project_activities_log': '/${AppRoutes.projectActivitiesLog}',
    'project_framework': '/${AppRoutes.projectFramework}',
    'project_goals_milestones': '/${AppRoutes.projectFrameworkNext}',
    'work_breakdown_structure': '/${AppRoutes.wbs}',
    'requirements': '/${AppRoutes.planningRequirements}',
    'ssher': '/${AppRoutes.ssherStacked}',
    'change_management': '/${AppRoutes.changeManagementModule}',
    'issue_management': '/${AppRoutes.issueManagement}',
    'cost_estimate': '/${AppRoutes.costEstimateScreen}',
    'scope_tracking_plan': '/${AppRoutes.scopeTrackingPlan}',
    'contracts': '/${AppRoutes.fepContracts}',
    'procurement': '/${AppRoutes.planningProcurement}',
    'project_plan': '/${AppRoutes.projectPlan}',
    'project_plan_level1_schedule': '/${AppRoutes.projectPlanLevel1Schedule}',
    'project_plan_detailed_schedule': '/${AppRoutes.projectPlanDetailedSchedule}',
    'project_plan_condensed_summary': '/${AppRoutes.projectPlanCondensedSummary}',
    'execution_plan': '/${AppRoutes.executionPlan}',
    'execution_plan_strategy': '/${AppRoutes.executionPlanSolutions}',
    ...
    'execution_plan_construction_plan': '/${AppRoutes.executionPlanConstructionPlan}',
    'execution_plan_infrastructure_plan': '/${AppRoutes.executionPlanInfrastructurePlan}',
    'agile_delivery_model': '/${AppRoutes.agileDeliveryModel}',
    'execution_plan_agile_delivery_plan': '/${AppRoutes.executionPlanAgileDeliveryPlan}',
    'agile_team_structure': '/${AppRoutes.agileTeamStructure}',
    'agile_kanban_config': '/${AppRoutes.agileKanbanConfig}',
    'agile_acceptance_criteria': '/${AppRoutes.agileAcceptanceCriteria}',
    'agile_epics_features': '/${AppRoutes.agileEpicsFeatures}',
    'agile_sprint_calendar': '/${AppRoutes.agileSprintCalendar}',
    'agile_map_out': '/${AppRoutes.deliverableRoadmapAgileMapOut}',
    'deliverable_roadmap_agile_map_out': '/${AppRoutes.deliverableRoadmapAgileMapOut}',
    'agile_release_plan': '/${AppRoutes.agileReleasePlan}',
    'agile_scrum_config': '/${AppRoutes.agileScrumConfig}',
    'agile_capacity_planning': '/${AppRoutes.agileCapacityPlanning}',
    'agile_backlog_governance': '/${AppRoutes.agileBacklogGovernance}',
    'agile_metrics_planning': '/${AppRoutes.agileMetricsPlanning}',
    'deliverables_roadmap_overview': '/${AppRoutes.deliverablesRoadmap}',
    'deliverables_roadmap_detailed': '/${AppRoutes.deliverablesRoadmapDetailed}',
    'document_review_matrix': '/${AppRoutes.documentReviewMatrix}',
    'execution_plan_interface_management': '/${AppRoutes.executionPlanInterfaceManagement}',
    'execution_plan_communication_plan': '/${AppRoutes.executionPlanCommunicationPlan}',
    'execution_plan_interface_management_plan': '/${AppRoutes.executionPlanInterfaceManagementPlan}',
    'execution_plan_interface_management_overview': '/${AppRoutes.executionPlanInterface}',
    'execution_plan_stakeholder_identification': '/${AppRoutes.executionPlanStakeholderIdentification}',
    'schedule': '/${AppRoutes.schedule}',
    'design': '/${AppRoutes.designPlanning}',
    'design_management': '/${AppRoutes.designPhase}',
    'technology': '/${AppRoutes.fepTechnology}',
    'interface_management': '/${AppRoutes.interfaceManagement}',
    'startup_planning': '/${AppRoutes.startupPlanning}',
    'startup_planning_operations': '/${AppRoutes.startupPlanningOperations}',
    'startup_planning_hypercare': '/${AppRoutes.startupPlanningHypercare}',
    'startup_planning_devops': '/${AppRoutes.startupPlanningDevOps}',
    'startup_planning_closeout': '/${AppRoutes.startupPlanningCloseOutPlan}',
    'deliverables_roadmap': '/${AppRoutes.deliverablesRoadmap}',
    'deliverable_roadmap': '/${AppRoutes.deliverablesRoadmap}',
    'project_baseline': '/${AppRoutes.projectBaseline}',
    'organization_roles_responsibilities': '/${AppRoutes.organizationRolesResponsibilities}',
    'organization_raci_matrix': '/${AppRoutes.organizationRaciMatrix}',
    'organization_staffing_plan': '/${AppRoutes.organizationStaffingPlan}',
    'team_training': '/${AppRoutes.teamTraining}',
    'stakeholder_management': '/${AppRoutes.stakeholderManagement}',
    'lessons_learned': '/${AppRoutes.lessonsLearned}',
    'team_management': '/${AppRoutes.teamManagement}',
    'risk_assessment': '/${AppRoutes.riskAssessment}',
    'security_management': '/${AppRoutes.securityManagement}',
    'quality_management': '/${AppRoutes.qualityManagement}',
    'requirements_implementation': '/${AppRoutes.requirementsImplementation}',
    'technical_alignment': '/${AppRoutes.technicalAlignment}',
    'development_set_up': '/${AppRoutes.developmentSetUp}',
    'ui_ux_design': '/${AppRoutes.uiUxDesign}',
    'backend_design': '/${AppRoutes.backendDesign}',
    'engineering_design': '/${AppRoutes.engineeringDesign}',
    'technical_development': '/${AppRoutes.technicalDevelopment}',
    'tools_integration': '/${AppRoutes.toolsIntegration}',
    'long_lead_equipment_ordering': '/${AppRoutes.longLeadEquipmentOrdering}',
    'specialized_design': '/${AppRoutes.specializedDesign}',
    'design_deliverables': '/${AppRoutes.designDeliverables}',
    'staff_team': '/${AppRoutes.staffTeam}',
    'team_meetings': '/${AppRoutes.teamMeetings}',
    'progress_tracking': '/${AppRoutes.progressTracking}',
    'deliverable_status_updates': '/${AppRoutes.deliverableStatusUpdates}',
    'recurring_deliverables': '/${AppRoutes.recurringDeliverables}',
    'status_reports': '/${AppRoutes.statusReports}',
    'contracts_tracking': '/${AppRoutes.contractsTracking}',
    'vendor_tracking': '/${AppRoutes.vendorTracking}',
    'detailed_design': '/${AppRoutes.detailedDesign}',
    'agile_development_iterations': '/${AppRoutes.agileDevelopmentIterations}',
    'scope_tracking_implementation': '/${AppRoutes.scopeTrackingImplementation}',
    'stakeholder_alignment': '/${AppRoutes.stakeholderAlignment}',
    'update_ops_maintenance_plans': '/${AppRoutes.updateOpsMaintenancePlans}',
    'launch_checklist': '/${AppRoutes.launchChecklist}',
    'risk_tracking': '/${AppRoutes.riskTracking}',
    'scope_completion': '/${AppRoutes.scopeCompletion}',
    'gap_analysis_scope_reconcillation': '/${AppRoutes.gapAnalysisScopeReconcillation}',
    'punchlist_actions': '/${AppRoutes.punchlistActions}',
    'technical_debt_management': '/${AppRoutes.technicalDebtManagement}',
    'identify_staff_ops_team': '/${AppRoutes.identifyStaffOpsTeam}',
    'salvage_disposal_team': '/${AppRoutes.salvageDisposalTeam}',
    'finalize_project': '/${AppRoutes.finalizeProject}',
    ...
    'actual_vs_planned_gap_analysis': '/${AppRoutes.actualVsPlannedGapAnalysis}',
    'project_close_out': '/${AppRoutes.projectCloseOut}',
    'demobilize_team': '/${AppRoutes.demobilizeTeam}',
  };
}
